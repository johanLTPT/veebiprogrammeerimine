...
if (isset($_POST["submit"])) {
    ...
    if (!empty($position)) {
      $notice = new_position($position, $description);
  }
}
?>
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
  ...
  <input type="text" name="positioninput" id="positioninput" placeholder="Pealkiri">
  <br>
  <label for="descriptioninput">Ameti lühikirjeldus</label><br>
  <textarea rows="2" cols="30" name="descriptioninput" id="descriptioninput" placeholder="lühikirjeldus.."></textarea>
  <br>
